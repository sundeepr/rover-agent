...
class RoombaController:
    ...
    def navigate_to_waypoint(self, waypoint: dict) -> None:
        """
        ...
        Steps:
          ...
          3. Drive forward for STEP_DURATION_S seconds.
          4. Stop.
        """
        px = int(waypoint["x"])
        ...
        log.info(
            "Navigating to waypoint rank=%s (%d, %d) p=%.0f%% — %s",
            waypoint.get("rank", "?"),
    ...
    def _drive_forward(self) -> None:
        """Drive straight forward for STEP_DURATION_S, then stop."""
        log.info("Driving forward for %.2fs", STEP_DURATION_S)
